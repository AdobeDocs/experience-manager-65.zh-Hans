...
组件在以下情况下可用 [编辑页面](/help/sites-authoring/editing-content.md). 为便于筛选，按主要功能区域（即组件组）对这些组件进行分组。
...
此 [组件控制台](/help/sites-authoring/default-components-console.md) 概述了由AEM安装提供的组件组和组件。 您可以查看有关单个组件及其用途的关键信息。
...
* [Communities](/help/communities/author-communities.md)  — 组件为网站提供交互功能，如论坛和评论。 在以下情况下会包含其中的许多组件： [社区站点](/help/communities/overview.md) 创建。
