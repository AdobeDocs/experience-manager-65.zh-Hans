...
打开侧面板时，左侧会打开该面板（如果需要，请选择&#x200B;**组件**&#x200B;选项卡）。 打开后，您可以浏览所有可用于页面的组件。
...
对于相应的资源（例如，**站点**&#x200B;控制台中的页面或&#x200B;**Assets**&#x200B;控制台中的资产），[时间轴可用于显示任何选定项目](/help/sites-authoring/basic-handling.md#timeline)上的近期活动。
...
“页面信息”按钮（均衡器图标）会打开一个菜单，其中还提供有关上次编辑和上次发布的详细信息。 根据页面、其站点、您的实例和您的权限的特性，可能有更多或更少的选项可用：
...
* [基架](/help/sites-authoring/scaffolding.md) — 可帮助您创建共享结构但内容不同的大量页面。
...
* [预览](/help/sites-authoring/editing-content.md#previewing-pages) — 用于查看发布环境中显示的页面，或使用内容中的链接进行导航。
