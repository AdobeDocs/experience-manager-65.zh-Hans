...
组件是AEM提供的元素，用于添加特定类型的内容。 AEM随附了一系列产品， [开箱即用的组件](/help/sites-authoring/default-components-console.md) 功能齐全。 其中包括：
...
1. 在向导的最后一步中，您可以执行以下操作之一：
   ...
   * 使用三个选项卡输入 [页面属性](/help/sites-authoring/editing-page-properties.md) ，然后单击 **创建** 以实际创建页面。
...
1. 在向导的&#x200B;**重命名**&#x200B;阶段，您可以执行以下任一操作：
   ...
   * 指定移动页面后您希望页面使用的名称，然后单击 **下一个** 以继续。
...
可以在中检查异步作业的状态 [**异步作业状态** 仪表板](/help/sites-administering/asynchronous-jobs.md#monitor-the-status-of-asynchronous-operations) 在 **全局导航** > **工具** > **操作** > **作业**
