...
1. 填写 **标题** 和（可选） **描述** 并单击 **创建**. 标题用作新闻稿/电子邮件的主题，除非您在编辑电子邮件时覆盖它。
...
您可以从中选择云服务 **站点** 选项卡，或从电子邮件/新闻稿中创建选项卡。

从中选择云服务 **站点** 选项卡是推荐的方法。 从电子邮件/新闻稿中选择云服务需要权宜之计。
...
1. 选择 **编辑** 然后 **云服务** 制表符并向下滚动到底部，单击+符号添加配置，然后选择 **Adobe Campaign**.

   ![chlimage_1-17](assets/chlimage_1-17a.png)

1. 从下拉列表中选择与您的Adobe Campaign实例匹配的配置，然后单击进行确认 **保存**.
1. 通过单击&#x200B;**Adobe Campaign** 选项卡。 如果要选择其他模板，您可以在编辑时从电子邮件中访问该模板。
...
从创作时的新闻稿/电子邮件中，您可能无法选择中的Adobe Campaign云服务配置 **页面属性** 由于布局问题。 您可以使用此处描述的解决方法：
...
1. 将组件直接拖到页面上并进行相应编辑。 例如，您可以拖动 **文本与个性化（营销活动）** 组件并添加个性化文本。

   ![chlimage_1-23](assets/chlimage_1-23a.png)

   请参阅 [Adobe Campaign组件](/help/sites-authoring/adobe-campaign-components.md) 以了解每个组件的详细说明。
...
1. 单击铅笔图标以打开组件。 将打开就地编辑器。
   ...
   >* **重要**：所有种子表字段也必须位于收件人表（或对应的contact表）中。
...
要批准Adobe Campaign的内容，请选择以应用工作流 **工作流** 并选择 **批准Adobe Campaign** 并单击 **启动工作流**. 完成相关步骤并批准内容。 您还可以通过选择拒绝内容 **拒绝** 而不是 **批准** 在最后一个工作流步骤中。
...
1. 根据特定于AEM的电子邮件模板创建电子邮件。 请参阅 [在Adobe Campaign Standard中创建电子邮件](https://helpx.adobe.com/campaign/standard/channels/using/creating-an-email.html) 以了解更多信息。
...
1. 执行电子邮件投放。 在投放分析期间，将检索AEM内容的最新版本。
   ...
   >[!NOTE]
   >
   如果内容在链接到电子邮件时在AEM中更新，则它会在分析期间在Adobe Campaign中自动更新。 同步也可以使用手动执行 **刷新Adobe Experience Manager内容** 内容操作栏中的。
   >
   您可以使用取消电子邮件与AEM内容之间的链接 **删除包含Adobe Experience Manager内容的链接** 内容操作栏中的。 仅当内容已链接到投放时，此按钮才可用。 要将其他内容与投放链接，必须先删除当前内容链接，然后才能建立新链接。
   >
...
1. 通过选择 **包含AEM内容的电子邮件投放(mailAEMContent)** 投放模板。
...
1. 选择 **同步** 以访问AEM中可用的内容列表。
   ...
   >[!NOTE]
   >
   如果 **同步** 选项不会出现在投放的工具栏中，请检查 **内容编辑模式** 字段已正确配置 **AEM** 通过选择 **属性** > **高级**.
...
1. 执行投放。 在投放分析期间，将恢复AEM内容的最新版本。
   ...
   * 如果内容在链接到Adobe Campaign中的某个投放时在AEM中更新，则在投放分析期间会在投放中自动更新。 也可以使用手动执行同步 **立即刷新内容** 按钮。
