...
1. 将段落拖到新位置。 AEM指示可以放置段落的位置。 将其放在您想要的位置。
...
锁定后，控制台视图信息将更新，编辑锁定符号时将显示在工具栏中。
...
>[!NOTE]
>
>对文件和图像进行更改的历史记录将保留至少 10 个小时。 然而，在这之后，改变的逆转并非板上钉钉。 您的管理员可以更改 10 个小时的默认保留时间。
