...
* [配置富文本编辑器以创建无障碍网站](/help/sites-administering/rte-accessible-content.md)
为管理员提供的指南，说明如何配置 AEM 以生成无障碍内容。

* [创建无障碍自适应表单](/help/forms/using/creating-accessible-adaptive-forms.md)
Adobe Experience Manager（AEM）提供多项功能和特性，可提升自适应表单对不同能力用户的可用性。该解决方案还可帮助表单作者创建无障碍自适应表单。
