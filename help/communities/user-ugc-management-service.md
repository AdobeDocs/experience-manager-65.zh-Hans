...
要从Adobe Analytics中删除用户数据，请遵循[GDPR Analytics工作流程](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/an-gdpr-workflow.html)，因为API不会从Adobe Analytics中删除用户数据。
