...
+ Forms {#forms}
   ...
   + HTML5 表单 {#html5-forms}
      ...
      + [HTML5 表单与 PDF 表单的功能差异](/help/forms/using/feature-differentiation-html5-forms-pdf-forms.md)
   ...
   + 疑难解答 {#troubleshooting}
      ...
      + [缓解JEE上AEM Forms的XXE、配置和远程代码执行漏洞](/help/forms/using/mitigating-xxe-and-configuration-vulnerabilities-for-experience-manager-forms-jee.md)
...
+ AEM 6.5人工智能助理 {#ai-assistant}
   + [在AEM中配置AI助手](/help/ai-assistant-in-aem-admin.md)
   + [关于AEM中的AI助手](/help/ai-assistant-in-aem.md)
+ 实施 {#implementing}
   + 开发 {#developing}
      + 开发人员简介 {#introduction}
