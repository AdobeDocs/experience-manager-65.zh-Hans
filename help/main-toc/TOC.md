...
+ Forms {#forms}
   ...
   + 安装和配置AEM Forms {#install-aem-forms}
      ...
      + 在OSGi {#osgi-installation}上安装AEM Forms
         ...
         + [安装和配置自动表单转换服务](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   ...
   + HTML5 表单 {#html5-forms}
      ...
      + [HTML5 Forms与PDF forms的功能差异](/help/forms/using/feature-differentiation-html5-forms-pdf-forms.md)
      ...
      + [设计无障碍的HTML5表单](/help/forms/using/design-accessible-html5-forms.md)
      ...
      + [创建HTML5表单的自定义配置文件](/help/forms/using/custom-profile.md)
      ...
      + [HTML5 Forms的Picture子句支持](/help/forms/using/picture-clause-support.md)
      ...
      + [调试HTML5 forms](/help/forms/using/debug.md)
   ...
   + 开发人员参考{#developer-reference}
      ...
      + 在JEE {#programming-aem-forms-jee}上使用AEM Forms编程
         ...
         + Java API快速入门 — 代码示例{#java-api-quick-start-code-examples}
            ...
            + [转换PDF服务Java API快速入门(SOAP)](/help/forms/developing/convert-pdf-service-java-api.md)
            ...
            + [DocConverter服务Java API快速入门(SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
            ...
            + [Output服务Java API快速入门(SOAP)](/help/forms/developing/output-service-java-api-quick.md)
            ...
            + [签名服务Java API快速入门(SOAP)](/help/forms/developing/signature-service-java-api-quick.md)
            + [任务管理器服务Java API快速入门(SOAP)](/help/forms/developing/task-manager-service-java-api.md)
         ...
         + 使用API {#performing-service-operations-using-apis}执行服务操作
            ...
            + [组合PDF项目组合](/help/forms/developing/assembling-pdf-portfolios.md)
            ...
            + [使用自定义CSS文件呈现HTML Forms](/help/forms/developing/rendering-html-forms-using-custom.md)
            + [使用CustomToolbars渲染HTML Forms](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
   ...
   + 疑难解答 {#troubleshooting}
      + [无法在某些版本的Oracle JDK中使用某些表单功能](/help/forms/using/unable-to-use-forms-features-with-certain-versions-of-oracle-jdk.md)
...
+ Content and Commerce {#commerce}
   ...
   + [对AEM内容和Commerce的显着更改](/help/commerce/cif/changes.md)
   + 集成 {#integrations}
   ...
   + AEM CIF Classic {#classic}
      ...
      + 开发 {#developing}
         ...
         + [使用SAP Commerce Cloud进行开发](/help/commerce/cif-classic/developing/sap-commerce-cloud.md)
+ Headless {#headless}
...
+ 实施 {#implementing}
   + 开发 {#developing}
      + 开发人员简介{#introduction}
         ...
         + [为AEM贡献内容](/help/sites-developing/contributing-to-cq.md)
      ...
      + 平台 {#platform}
         ...
         + 标记{#tagging}
            ...
            + [在AEM应用程序中构建标记](/help/sites-developing/building.md)
   ...
   + 正在部署{#deploying}
      ...
      + 存储库重组{#restructuring}
         ...
         + [AEM 6.5中的E-Commerce存储库重构](/help/sites-deploying/ecommerce-repository-restructuring-in-aem-6-5.md)
