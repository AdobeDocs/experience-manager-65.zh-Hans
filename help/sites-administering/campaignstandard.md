...
1. 单击菜单栏左上角的Adobe Campaign徽标以打开全局导航，然后选择 **管理** > **用户和安全性** > **用户** 导航菜单。

1. 单击 `aemserver` 用户控制台中的用户。
...
1. 单击菜单栏左上角的Adobe Campaign徽标以打开全局导航，然后选择 **管理** > **应用程序设置** > **选项** 导航菜单。

1. 单击 `AEMResourceTypeFilter` 在选项控制台中。
...
1. 单击菜单栏左上角的Adobe Campaign徽标以打开全局导航，然后选择 **资源** > **模板** > **投放模板** 导航菜单。
...
1. 单击菜单栏左上角的Adobe Campaign徽标以打开全局导航，然后选择 **管理** > **应用程序设置** > **外部帐户** 导航菜单。

1. 单击 **Adobe Experience Manager实例(aemInstance)** 用户控制台中的用户。
