...
* 仅在AEM组件对话框中支持RTE功能。 在启用触屏UI上的向导或基础表单（如[页面属性](/help/sites-developing/page-properties-views.md)和[基架](/help/sites-authoring/scaffolding.md)）上不支持RTE。
...
>* [触屏UI和经典UI对等功能](../release-notes/touch-ui-features-status.md)
