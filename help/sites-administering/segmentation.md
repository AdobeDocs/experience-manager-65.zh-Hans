...
[受众](/help/sites-authoring/managing-audiences.md)控制台用于管理ContextHub或Client Context的区段以及Adobe Target帐户的受众。 本文档介绍了如何管理 ContextHub 的区段。 有关[客户端上下文区段](/help/sites-administering/campaign-segmentation.md)和Adobe Target区段，请参阅相关文档。
...
例如，我们用来标识主要年龄组中的用户的简单区段定义是基于用户年龄和性别的简单区段定义。 加载符合这些条件的特定用户画像会显示是否已成功解析该区段：
