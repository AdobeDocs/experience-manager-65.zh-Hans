---
title: 如何在Adobe Experience Manager中审核用户管理操作
description: 了解如何在Adobe Experience Manager中审核用户管理操作。
contentOwner: User
...
# 如何在Adobe Experience Manager (AEM)中审核用户管理操作 {#how-to-audit-user-management-operations-in-aem}

## 简介 {#introduction}

AEM引入了记录权限更改的功能，以便您以后可以审核这些更改。
