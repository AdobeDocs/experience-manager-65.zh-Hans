...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li> 升级到AEM Forms Service Pack 6.5.21.0后，PaperCapture服务无法对PDF执行OCR（光学字符识别）操作。 有关安装说明，请参阅<a href="/help/forms/using/papercapture-service-resolution.md">疑难解答</a>文章。(CQDOC-21680) </li>
    </ul>
    </td>    
  </tr>
  <tr>
