...
使用[!DNL Brand Portal]配置[!DNL Experience Manager Assets]的步骤因您的[!DNL Experience Manager]版本以及您是首次配置还是升级现有配置而异。 有关详细信息，请参阅[使用Brand Portal配置Experience Manager Assets](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/publish/configure-aem-assets-with-brand-portal.html)。
