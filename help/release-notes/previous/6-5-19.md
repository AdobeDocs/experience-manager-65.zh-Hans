...
[!DNL Experience Manager] 6.5.19.0包括自2019年4月6.5首次发布以来发布的新功能、关键客户请求的增强功能、错误修复以及性能、稳定性和安全性改进。 在[!DNL Experience Manager] 6.5上[安装此Service Pack](#install)。
...
* 当客户保存具有多个字段的元数据架构时，表单生成器的多部分/表单数据请求超出maxFileCount限制，导致静默失败。 (CQDOC-22465)
