...
* 更正了页面锁定/解锁工作流中显示的锁定状态消息中的低对比度。 该报文现在达到了4.5:1的比率，提高了可读性，并符合作者的ADA合规性。 （SITES-27270）
...
* Adobe提高了站点主页中引用文本的颜色对比度。 文本现在符合WCAG 2.1 AA，比例至少为4.5:1，并且在浅色主题和明亮屏幕上可清晰阅读。 （SITES-24755）
...
## 已包含的 OSGi 捆绑包和内容包 {#osgi-bundles-content-packages}

以下zip文件包含文本文档，其中列出了此[!DNL Experience Manager] 6.5 Service Pack版本中包含的OSGi包和内容包：

<!-- UPDATE FOR EACH NEW RELEASE -->

* [OSGi包](/help/release-notes/assets/65240-bundles.zip)
* [内容包](/help/release-notes/assets/65240-packages.zip)
