...
* [Experience Manager 6.5.24.0 中包含的 OSGi 捆绑包列表](/help/release-notes/assets/65240-bundles.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.24.0 中包含的内容包列表](/help/release-notes/assets/65240-packages.zip)
<!-- UPDATE FOR EACH NEW RELEASE -->
