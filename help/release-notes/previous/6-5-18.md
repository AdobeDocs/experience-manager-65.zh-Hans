...
* **[增强的Adobe Sign工作流步骤](https://experienceleague.adobe.com/docs/experience-manager-65/forms/workflows/aem-forms-workflow-step-reference.html?lang=zh-Hans#sign-document-step)** - AEM Workflow中的Adobe Sign工作流步骤包含以下增强功能。
...
* 如[配置浏览器文档](https://experienceleague.adobe.com/docs/experience-manager-65/administering/introduction/configurations.html?lang=zh-Hans#using-configuration-browser)中所述，_名称将成为存储库中的节点名称_。 但是，在Configuration Browser中， Configuration Title用于CRXDE Lite中的路径，而Name of the Configuration被忽略。 (NPR-40607)
