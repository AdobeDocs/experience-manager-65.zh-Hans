...
[!DNL Experience Manager] 6.5.16.0包括自2019年4月6.5首次发布以来发布的新功能、关键客户请求的增强功能、错误修复以及性能、稳定性和安全性改进。 [在[!DNL Experience Manager] 6.5上安装此Service Pack](#install)。<!-- UPDATE FOR EACH NEW RELEASE -->
...
新协议DASH(Dynamic Adaptive Streaming over HTTP)支持在Dynamic Media视频交付中启动自适应比特率流（启用了CMAF [通用媒体应用程序格式]）。
...
安装AEM 6.5.16.0 Forms附加组件服务包后，客户遇到以下所列问题。 因此，已发布[AEM 6.5.16.0 Forms附加组件Service Pack - 6.0.914](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html)的更新版本。 Adobe建议使用更新的Service Pack：
...
* 从Experience Manager 6.5中删除Adobe Search&amp;Promote代码和依赖项。Adobe Search&amp;Promote已于2022年9月终止服务。 请参阅[Adobe Search&amp;Promote服务结束公告](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html)。 (NPR-39706)
