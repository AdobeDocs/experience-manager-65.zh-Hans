...
[!DNL Experience Manager] 6.5.17.0包括自2019年4月6.5首次发布以来发布的新功能、关键客户请求的增强功能、错误修复以及性能、稳定性和安全性改进。 在[!DNL Experience Manager] 6.5上[安装此Service Pack](#install)。
...
* 使用Dynamic Media的&#x200B;**DASH流** — 为Dynamic Media视频交付中的自适应流启动了新的协议(DASH - Dynamic Adaptive Streaming over HTTP)支持（已启用CMAF）。
...
* 正在向`fd-cloudservice`系统用户添加`modifyProperties`权限以进行Adobe Sign配置。 (FORMS-6164)
