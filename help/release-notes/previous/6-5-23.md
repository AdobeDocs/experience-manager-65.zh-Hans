...
* [Experience Manager 6.5.23.0 中包含的 OSGi 捆绑包列表](/help/release-notes/assets/65230-bundles.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5.23.0 中包含的内容包列表](/help/release-notes/assets/65230-packages.txt)
<!-- UPDATE FOR EACH NEW RELEASE -->
