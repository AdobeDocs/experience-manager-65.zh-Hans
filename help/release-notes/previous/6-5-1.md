...
* 在OAuth期间，对[!DNL Brand Portal]的每个复制都会发生会话泄漏。 NPR-30001：适用于GRANITE-26196的修补程序
...
* 为[!DNL Experience Manager Assets]启用了多站点管理器支持。 有关详细信息，请参阅[使用MSM为Experience Manager Assets重复使用资源](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/reuse-assets-using-msm.html)。 NPR-29199：适用于 CQ-4259922 的修补程序

### 站点 — 已包含

* 将[!DNL Experience Manager]体验片段导出到[!DNL Adobe Target]。 有关更多详细信息，请参阅[体验片段链接重写器提供程序 — HTML](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/experience-fragments.html#the-experience-fragment-link-rewriter-provider-html)。 适用于 CQ-4265469 的修补程序
