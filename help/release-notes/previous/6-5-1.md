...
[!DNL Adobe Experience Manager] 6.5.1.0是一个重要版本，其中包括自2019年4月&#x200B;*日[!DNL Adobe Experience Manager] 6.5正式发布以来发布的性能、稳定性、安全性和关键客户修复和增强功能。* 它可以直接安装在 [!DNL Experience Manager] 6.5 之上。
...
* 仅限OSGi：在输出和Forms服务中添加了新属性PAGECOUNT 。NPR-28922：适用于CQ-4270870的修补程序
