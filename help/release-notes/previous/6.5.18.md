...
* 在自适应表单的指南容器中设置重定向URL后，内联签名将停止工作。 (FORMS-10493)。 有针对此问题的修补程序。 要下载并安装修补程序，请参阅 [](/help/release-notes/aem-forms-hotfix.md)
* 所有记录文档(DoR)模板均无法发布。 仅发布基于区域设置的英文DoR模板及其关联的基于Forms的DoR模板。 (FORMS-10535)。 有针对此问题的修补程序。 要下载并安装修补程序，请参阅 [](/help/release-notes/aem-forms-hotfix.md)
* 弹出窗口预览对AEM 6.5 Forms Service Pack 18中的涂写签名组件不起作用。 (FORMS-12073)

#### 交互式通信

* 升级到AEM Service Pack 18后，无法编辑交互式通信信件。 (FORMS-10578)。 有针对此问题的修补程序。 要下载并安装修补程序，请参阅 [](/help/release-notes/aem-forms-hotfix.md)
