...
* 用户无法创建通信管理信件。 当用户创建信件时，出现描述为“`Object Object`”的错误，并且信件未创建。 在信件创建屏幕上加载布局缩略图也失败。 您可以安装[最新的AEM 6.5 Form Service Pack 20 (6.5.20.0)](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases)来解决此问题。 (FORMS-13496)
* 交互式通信服务会创建PDF文档，但表单字段中不会自动填充用户数据。 预填充服务未按预期运行。 您可以安装[最新的AEM 6.5 Form Service Pack 20 (6.5.20.0)](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases)来解决此问题。 (FORMS-13413和FORMS-13493)
* 自动表单转换服务的审核和更正(RnC)编辑器加载失败。 您可以安装[最新的AEM 6.5 Form Service Pack 20 (6.5.20.0)](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases)来解决此问题。 (FORMS-13491)
