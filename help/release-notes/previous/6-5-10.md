...
* 您现在可以使用自动化表单转化服务，[将 PDF Forms（法语、德语、西班牙语、意大利语和葡萄牙语）转化](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/extending-the-default-meta-model.html#language-specific-meta-model)为自适应表单。
