...
* 增强了“连接的资产”功能，从而添加了对从远程DAM部署获取文档的支持。 站点作者现在可以在内容查找器中搜索和筛选支持的文档类型。 可以将远程文档添加到网页上的下载组件中。 适用于CQ-4270245的修补程序。 请参阅 [使用连接的资产](/help/assets/use-assets-across-connected-assets-instances.md).
...
* 快捷方式触发器，阻止用户在特定用户界面中使用“m”、“p”、“e”。 NPR-30355：适用于GRANITE-26346的修补程序
* 正在关闭 [!DNL Experience Manager Assets] 搜索UI不会将左边栏重置为内容选择，从而导致用户随后第二次打开过滤器边栏。 NPR-30509：适用于 CQ-4274716 的修补程序
* 多租户环境： [!DNL Experience Manager Assets] 用户界面顶部导航不可用，并会引发JavaScript错误。 NPR-30104：适用于GRANITE-26344的修补程序
