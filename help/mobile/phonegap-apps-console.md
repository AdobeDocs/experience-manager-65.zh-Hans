...
AEM移动应用程序开发流程承认，拥有不同专业知识的用户对移动应用程序的开发做出了贡献。 以下流程图说明了内容作者和应用程序开发人员执行任务的一般顺序。
...
* Analytics：单击管理配置并设置您的[Adobe Mobile Services SDK](https://experienceleague.adobe.com/docs/mobile-services/using/home.html)云服务。 然后，您可以从下拉菜单中选择新创建的移动服务，以将其集成到移动应用程序中。
...
1. （可选）如果您使用PhoneGap Build编译应用程序，请在Build选项卡上选择要使用的配置。

   要创建PhoneGap Build配置，请单击管理配置。

1. （可选）如果您使用SiteCatalyst跟踪应用程序活动，请在Analytics选项卡上，选择要使用的配置。
...
最新的AEM应用程序6.1示例包中包含带有应用程序模板的Geometrixx应用程序的更新版本。 或者，您可以安装同时提供模板的StarterKit。

基于应用程序模板创建应用程序的步骤：

1. 确保您已安装最新的AEM应用程序6.1功能包和参考示例包
1. 单击左边栏中的应用程序。
...
1. 提供应用程序ID和标题，但您可能还希望包含名称和描述。
   ...
   1. 此外，您还可以通过浏览AEM资源提供PNG（支持的PhoneGap图标格式）作为图标。
...
>[!NOTE]
>
>如果您从AEM中卸载Geometrixx Outdoors引用应用程序包，并根据其模板创建了一个应用程序，则该应用程序将无法再正常使用。 可以删除Geometrixx Outdoors应用程序，但是，如果其他移动设备应用程序正在使用该模板，则必须保留该应用程序模板。

## 探索示例Geometrixx Outdoors应用程序 {#exploring-the-sample-geometrixx-outdoors-app}
...
### 常见页面功能 — Geometrixx移动设备应用程序 {#common-page-features-geometrixx-mobile-app}
...
### 齿轮页面 — Geometrixx移动设备应用程序 {#the-gear-page-geometrixx-mobile-app}
