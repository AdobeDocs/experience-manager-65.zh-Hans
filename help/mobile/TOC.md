...
+ 管理On-Demand Services应用{#administering}
   ...
   + [使用Preflight预览](aem-mobile-manage-ondemand-services.md)
...
+ 创作Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [使用“创建”向导创建AEM Mobile应用程序](phonegap-create-new-app.md)
   + [创作移动设备应用程序](phonegap-authoring-apps.md)
   + [管理应用程序磁贴](phonegap-app-details-tile.md)
...
+ 开发Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [通过内容同步处理移动设备](phonegap-contentsync.md)
   + [应用程序的剖析](phonegap-apps-arch.md)
   ...
   + [您的混合应用程序是否已为AEM Mobile做好准备？](phonegap-adding-content-to-imported-app.md)
