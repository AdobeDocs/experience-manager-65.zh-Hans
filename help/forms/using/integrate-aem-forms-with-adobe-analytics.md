...
在创建Adobe Launch配置之前，请使用Adobe Launch作为云解决方案创建[Adobe IMS配置](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/connect-aem-launch-adobe-io.html)。
...
>[!NOTE]
>
> 当您[将AEM Forms嵌入到AEM Sites页面](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/embed-adaptive-form-aem-sites)中时，iFrame中的自适应表单不支持Adobe Launch配置。 要解决此问题，请直接在站点页面上配置Adobe Launch规则，或将现有Adobe Launch配置从AEM Forms迁移到站点页面。
