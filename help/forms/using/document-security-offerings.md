...
* **Adobe Acrobat：**&#x200B;您可以使用Adobe Acrobat将安全策略应用于PDF使用常用桌面应用程序(如Microsoft®Office、Web浏览器或任何支持PDF打印的应用程序)创建的文档。
  ...
  您可以从[Adobe网站](https://www.adobe.com/acrobat/free-trial-download.html)购买并下载Adobe Acrobat。 Adobe Acrobat文章[为PDF设置安全策略](https://helpx.adobe.com/acrobat/using/setting-security-policies-pdfs.html)提供了有关在Adobe Acrobat中创建和应用策略的详细信息。
