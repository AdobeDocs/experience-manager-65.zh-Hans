...
* 在Microsoft® Windows®上，Acrobat和Reader允许您配置以在“受保护的视图”模式下打开PDF，从而阻止打开基于XFA的PDF forms。 确保Acrobat或Reader中的“受保护的视图”模式已禁用。 有关详细信息，请参阅[受保护的视图（仅限Windows）](https://helpx.adobe.com/in/reader/using/protected-mode-windows.html)。
