...
**保留已校准CMYK色彩空间的CMYK值：**&#x200B;选中后，与设备无关的CMYK值将被视为与设备相关的(DeviceCMYK)值，与设备无关的色彩空间将被丢弃，PDF/X-1a文件会使用“将所有色彩转换为CMYK”值。 取消选择后，如果颜色管理策略设置为“将所有颜色转换为CMYK”，则与设备无关的色彩空间将转换为CMYK。
