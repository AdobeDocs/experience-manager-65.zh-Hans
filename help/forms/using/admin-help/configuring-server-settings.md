...
要为组生成电子邮件通知，请在用户管理中指定组的电子邮件地址。 <!--Fix broken link See Setting up and organizing users -->当表单工作流向组发送电子邮件通知时，组内每个具有指定电子邮件地址的成员都会收到电子邮件通知。 当组的成员收到电子邮件通知并想要申请任务时，该成员必须单击电子邮件通知中的“申请”链接，这会打开Workspace中的“任务详细信息”页面。 从那里，成员可以声明或声明并打开工作项。
