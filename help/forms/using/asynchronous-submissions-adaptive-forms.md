...
| 版本 | 文章链接 |
| -------- | ---------------------------- |
| AEM as a Cloud Service | [单击此处](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/asynchronous-submissions-adaptive-forms.html?lang=zh-Hans) |
| AEM 6.5 | 本文 |
...
1. 在&#x200B;**[!UICONTROL 在提交]**&#x200B;部分中，选择下列选项之一以在成功提交表单时执行。
   ...
   * **[!UICONTROL 显示消息]**：在提交表单时显示消息。 您可以在“显示消息”选项下方的文本字段中写入消息。 文本字段支持富文本格式。
...
表单开发人员和作者可以在代码编辑器中在表单级别编写规则以覆盖默认处理程序。 成功和错误事件的服务器响应在表单级别公开，开发人员可以在规则中使用`$event.data`访问该级别。
...
1. 在代码编辑器中，选择&#x200B;**[!UICONTROL 编辑代码]**。 在确认对话框上选择&#x200B;**[!UICONTROL 编辑]**。
1. 从&#x200B;**[!UICONTROL Event]**&#x200B;下拉列表中选择&#x200B;**[!UICONTROL 提交成功]**&#x200B;或&#x200B;**[!UICONTROL 提交出错]**。
1. 为所选事件编写规则，然后选择&#x200B;**[!UICONTROL 完成]**&#x200B;以保存规则。
