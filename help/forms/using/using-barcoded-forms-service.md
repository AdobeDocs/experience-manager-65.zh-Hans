...
* **[解码](https://helpx.adobe.com/cn/experience-manager/6-3/forms/javadocs/com/adobe/fd/bcf/api/BarcodedFormsService.html#decode)**：解码输入PDF文档或tiff图像中可用的所有条形码。 它返回另一个XML文档，该文档包含从输入文档或图像中的所有可用条形码检索的数据。
