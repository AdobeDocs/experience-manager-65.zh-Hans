...
要在AEM 6.5 Forms环境中启用自适应Forms核心组件，请在所有Author和Publish实例上设置并部署基于[AEM Archetype 41或更高版本](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html)的项目（启用表单选项）。
