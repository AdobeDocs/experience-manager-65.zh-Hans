...
# 将用户数据添加到表单提交的元数据中{#adding-information-from-user-data-to-form-submission-metadata}
...
1. 在编辑模式下，选择一个组件，选择![字段级](assets/field-level.png) > **自适应表单容器**，然后选择![cmppr](assets/cmppr.png)。
1. 在侧边栏中，单击&#x200B;**元数据**。
1. 在元数据部分中，单击&#x200B;**添加**。
