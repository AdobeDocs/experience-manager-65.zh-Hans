...
- **Service Pack覆盖范围**： Adobe为运行过去18个月内发布的任何Service Pack的AEM Forms环境提供技术支持。 如果您的当前版本在此18个月窗口之外，Adobe强烈建议升级到最新的Service Pack以保持最佳性能、安全性和持续支持。
...
>[!NOTE]
>
> 有关与支持的格式或平台版本相关的任何查询，请联系AEM Forms支持。
