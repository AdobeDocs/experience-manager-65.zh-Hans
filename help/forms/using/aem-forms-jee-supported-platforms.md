...
>[!NOTE]
>
>- 从AEM Forms Service Pack 6.5.25.0开始，支持JBoss® Enterprise Application Platform (EAP) 7.4.23。 您可以使用此[链接](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/featurepack/jboss-eap-7.4.23-1.0.16.zip)从软件分发门户下载JBoss® EAP 7.4.23。
...
>- PDF Generator需要受支持的32位Windows内部版本：Adobe Acrobat Pro DC（连续跟踪，最新版本），用于Acrobat驱动的本机转换；32位Microsoft® Office Professional Plus，用于Microsoft® Windows上基于Office的转换。 通过功能限制许可(FRL)或Adobe企业部署过程激活Acrobat；请参阅文档服务安装文章中的[安装Adobe Acrobat Pro DC](install-configure-document-services.md#install-adobe-acrobat-pro-dc)。
...
>[!NOTE]
>
>AEM Forms不支持Adobe Acrobat 2020 （传统跟踪）。 请改用Adobe Acrobat Pro DC（连续跟踪，最新版本）。
>
...
| IBM® Content Manager 客户端 8.7 | ® Content Manager客户端8.5 | |
