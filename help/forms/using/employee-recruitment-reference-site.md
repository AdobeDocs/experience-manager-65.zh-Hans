...
该组织将接收Sarah提交的职位申请。 招聘人员John Jacobs被指派检查Sarah的信息配置文件。 John查看其AEM收件箱中的任务，找到与工作要求匹配的配置文件，然后单击“短列表”。 莎拉的简介被转发给招聘经理格洛丽亚·里奥斯，以征求她的同意。
...
莎拉·罗斯收到签名信。 Sarah点击此处查看并签署加入信。 将打开加入书信PDF，其中包含一个用于签署文档的字段。
