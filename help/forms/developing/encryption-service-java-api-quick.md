---
title: 加密服务Java&trade； API QuickStart(SOAP)
description: 了解如何在SOAP模式下使用Java&trade； API加密、删除基于密码/证书的加密、解锁和确定PDF文档的加密类型。
contentOwner: admin
...
[快速启动(SOAP模式)：使用Java删除基于密码的加密](encryption-service-java-api-quick.md#quick-start-soap-mode-removing-password-based-encryption-using-the-java-api)

[快速入门(SOAP模式)：使用Java对包含证书的PDF文档进行加密](encryption-service-java-api-quick.md#quick-start-soap-mode-encrypting-a-pdf-document-with-a-certificate-using-the-java-api)

[快速启动(SOAP模式)：使用Java删除基于证书的加密](encryption-service-java-api-quick.md#quick-start-soap-mode-removing-certificate-based-encryption-using-the-java-api)

[快速入门(SOAP模式)：使用Java解锁已加密的PDF文档](encryption-service-java-api-quick.md#quick-start-soap-mode-unlocking-an-encrypted-pdf-document-using-the-java-api)

[快速启动(SOAP模式)：使用Java确定加密类型](encryption-service-java-api-quick.md#quick-start-soap-mode-determining-encryption-type-using-the-java-api)
...
以下Java™代码示例加密名为的PDF文档 *Loan.pdf* 密码值为 `OpenPassword`. 主密码为 `PermissionPassword`. 受保护的PDF文档将保存为名为的PDF文件 *EncryptLoan.pdf*. (请参阅 [使用密码加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-a-password).)
...
以下Java™代码示例从名为的PDF文档中删除基于密码的加密 *EncryptLoan.pdf*. 用于删除基于密码的加密的主要密码值为 *Permissionpassword*. 不安全的PDF文档将另存为名为的PDF文件 *noEncryptionLoan.pdf*. (请参阅 [删除密码加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-password-encryption).)
...
以下Java™代码示例加密名为的PDF文档 *Loan.pdf* 具有名为的证书 *Encryption.cer*. 加密的PDF文档保存为名为的PDF文件 *EncryptLoanCert.pdf*. (请参阅 [使用证书加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-certificates).)
...
以下Java™代码示例从名为的PDF文档中删除基于证书的加密 *EncryptLoanCert.pdf*. 用于删除加密的公共密钥的别名是 `Encryption`. 不安全的PDF文档将另存为名为的PDF文件 *noEncryptionLoan.pdf*. (请参阅 [删除基于证书的加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-certificate-based-encryption).)
...
以下Java™代码示例解锁一个密码加密的PDF文档，该文档名为 *EncryptLoan.pdf*. (请参阅 [解锁加密的PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#unlocking-encrypted-pdf-documents).)
...
## 快速启动(SOAP模式)：使用Java™ API确定加密类型 {#quick-start-soap-mode-determining-encryption-type-using-the-java-api}

以下Java™代码示例确定用于保护名为的PDF文档的加密类型 *EncryptLoan.pdf*. (请参阅 [确定加密类型](/help/forms/developing/encrypting-decrypting-pdf-documents.md#determining-encryption-type).)
