...
以下Java™代码示例对名为&#x200B;*Loan.pdf*&#x200B;且密码值为`OpenPassword`的PDF文档进行加密。 主密码为`PermissionPassword`。 安全PDF文档保存为名为&#x200B;*EncryptLoan.pdf*&#x200B;的PDF文件。 (请参阅[使用密码加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-a-password)。)
...
以下Java™代码示例从名为&#x200B;*EncryptLoan.pdf*&#x200B;的PDF文档中删除基于密码的加密。 用于删除基于密码的加密的主要密码值为&#x200B;*PermissionPassword*。 不安全的PDF文档保存为名为&#x200B;*noEncryptionLoan.pdf*&#x200B;的PDF文件。 （请参阅[删除密码加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-password-encryption)。）
...
以下Java™代码示例使用名为&#x200B;*Encryption.cer*&#x200B;的证书对名为&#x200B;*Loan.pdf*&#x200B;的PDF文档进行加密。 加密的PDF文档保存为名为&#x200B;*EncryptLoanCert.pdf*&#x200B;的PDF文件。 (请参阅[使用证书加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-certificates)。)
...
以下Java™代码示例从名为&#x200B;*EncryptLoanCert.pdf*&#x200B;的PDF文档中删除基于证书的加密。 用于删除加密的公钥的别名为`Encryption`。 不安全的PDF文档保存为名为&#x200B;*noEncryptionLoan.pdf*&#x200B;的PDF文件。 （请参阅[删除基于证书的加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-certificate-based-encryption)。）
...
以下Java™代码示例确定保护名为&#x200B;*EncryptLoan.pdf*&#x200B;的PDF文档的加密类型。 （请参阅[确定加密类型](/help/forms/developing/encrypting-decrypting-pdf-documents.md#determining-encryption-type)。）
