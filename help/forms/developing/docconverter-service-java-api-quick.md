---
title: DocConverter服务Java&amp；trade；API QuickStart(SOAP)
...
以下Java™代码示例确定输入PDF文档是否符合PDF/A标准。 传递到DocConverter服务的输入PDF文档名为&#x200B;*LoanArchive.pdf*。 验证结果将写入名为&#x200B;*ValidationResults.xml*&#x200B;的XML文件。 (请参阅[以编程方式确定PDF/合规性](/help/forms/developing/pdf-a-documents.md#programmatically-determining-pdf-a-compliancy)。)
