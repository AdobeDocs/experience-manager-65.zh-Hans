...
[快速入门(SOAP模式)：使用Java根据片段渲染表单](forms-service-api-quick-starts.md#quick-start-soap-mode-rendering-a-form-based-on-fragments-using-the-java-api)
...
## 快速入门(SOAP模式)：渲染使用CSS文件的HTML表单(使用Java™ API) {#quick-start-soap-mode-rendering-an-html-form-that-uses-a-css-file-using-the-java-api}
