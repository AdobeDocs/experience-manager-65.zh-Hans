...
|--- |--- |---|--- |
| 对于新资产 | 启用FPO呈现版本([帮助](#generate-renditions-of-new-assets-using-aem-workflow)) | 在Experience Manager工作流中添加ImageMagick命令行([帮助](#generate-renditions-of-new-assets-using-imagemagick)) | Experience Manager对每次上传执行DAM更新资产工作流。 |
...
1. 单击 **[!UICONTROL 工具]** > **[!UICONTROL 工作流]** > **[!UICONTROL 模型]**. 选择 **[!UICONTROL DAM更新资产]** 模型和点击 **[!UICONTROL 编辑]**.

1. 选择 **[!UICONTROL 进程缩略图]** 步骤并单击 **[!UICONTROL 配置]**.

1. 单击 **[!UICONTROL FPO演绎版]** 选项卡。 选择 **[!UICONTROL 启用FPO呈现版本创建]**.

   ![fpo_rendition_damupdateasset_model](assets/fpo_rendition_damupdateasset_model.png)

1. 调整 **[!UICONTROL 质量]** 并添加或修改 **[!UICONTROL 格式列表]** 所需的值。 默认情况下，用于生成FPO演绎版的MIME类型列表为pjpeg、jpeg、jpg、gif、png、x-png和tiff。 单击&#x200B;**[!UICONTROL 完成]**。
...
1. 选择 **[!UICONTROL DAM更新资产]** 模型和点击 **[!UICONTROL 编辑]**.
...
1. 在 **[!UICONTROL 参数]** 选项卡，添加相关 **[!UICONTROL Mime类型]** 提供命令适用的文件格式列表。
...
1. 单击 **[!UICONTROL 切换侧面板]** “搜索流程缩略图”步骤。

1. 选择 **[!UICONTROL 进程缩略图]** 并单击 **[!UICONTROL 配置]**. 请遵循 [用于使用Experience Manager工作流生成新资源演绎版的配置](#generate-renditions-of-new-assets-using-aem-workflow).
...
1. 从执行步骤1到步骤3 [用于使用Experience Manager工作流生成现有资源演绎版的配置](#generate-renditions-of-existing-assets-using-aem-workflow) 部分。

1. 从执行步骤4到步骤8 [使用ImageMagick生成新资源演绎版的配置](#generate-renditions-of-new-assets-using-imagemagick) 部分。


## 查看FPO呈现版本 {#view-fpo-renditions}

您可以在工作流完成后检查生成的FPO呈现版本。 在Experience Manager Assets用户界面中，单击资源以打开大型预览。 打开左边栏并选择“格式副本”。 或者，使用键盘快捷键 `Alt + 3` 打开预览时。
...
* 有关资产的常规命令行处理，请参阅 [用于处理资产的命令行处理程序](media-handlers.md).
