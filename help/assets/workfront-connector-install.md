...
>[!NOTE]
>
> 使用公司代理服务器时，在[!UICONTROL Apache HTTP组件代理配置PID]中包含[!DNL workfront]以使[!UICONTROL 增强型Workfront连接器]能够识别它。 所需的PID格式为： `org.apache.http.proxyconfigurator~workfront`。
