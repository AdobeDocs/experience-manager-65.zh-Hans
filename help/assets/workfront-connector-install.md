...
1. 将自定义属性添加到的开箱即用索引定义中 **`ntFolderDamLucene(/oak:index/ntFolderDamLucene)`**. 执行以下步骤：
   * 添加 **`nt:unstructured`** 命名的属性 **`wfReferenceNumber`** 至：
     `/oak:index/ntFolderDamLucene/indexRules/nt:folder/properties/wfReferenceNumber`。
   * 重新索引 `index /oak:index/ntFolderDamLucene` 通过将重新索引标记翻转到 `true`.
...
1. 要验证连接，请在中访问 [!DNL Workfront] 并验证API密钥是否相同，以及连接是否为 **[!UICONTROL 已启用]**. 要执行此操作，请选择 **[!UICONTROL 设置]** > **[!UICONTROL 文档]** > **[!UICONTROL 自定义集成]** 在 [!DNL Workfront].
