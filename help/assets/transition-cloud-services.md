...
[!DNL Adobe Experience Manager] 让您能够获得所选翻译提供商提供的基于云的翻译服务，以确保您的资产已根据您的要求进行翻译。
...
1. 从包管理器安装连接器。
1. 单击 [!DNL Experience Manager] 徽标，并导航到 **[!UICONTROL 工具]** > **[!UICONTROL 部署]** > **[!UICONTROL Cloud Service]**.
