...
1. 在 [!DNL Experience Manager] 界面，选择 [!UICONTROL 资产].

1. 从选项中，选择 **[!UICONTROL 模板]**.

   ![chlimage_1-101](assets/chlimage_1-306.png)

1. 选择 **[!UICONTROL 创建]**，然后从菜单中选择您要创建的宣传品。 例如，选择 **[!UICONTROL 宣传册]**.
...
1. 要打开宣传资料进行编辑，请执行下列操作之一：
   ...
   * 打开您在步骤7中创建的宣传品（此例中为宣传册），共 [创建宣传材料](/help/assets/asset-templates.md#creating-a-collateral).
   ...
   * 选择宣传品，然后单击 **[!UICONTROL 编辑]** 工具栏中。
   ...
   要使用资产查找器，您可以在中浏览或搜索图像 [!DNL Experience Manager Assets] 并将模板中的可编辑图像替换为您选择的图像。

   ![chlimage_1-109](assets/chlimage_1-314.png)

   可编辑的图像显示在右侧。 对于在中可编辑的字段 [!DNL Experience Manager Assets]，模板中的相应字段必须标记为 [!DNL InDesign]. 换句话说，它们应该在中标记为可编辑 [!DNL InDesign].
...
1. 选择 **[!UICONTROL 预览]** ，以便预览所有更改。 选择 **[!UICONTROL 完成]** 以保存对宣传品片段的编辑更改。
...
1. 宣传品部分是在您开始使用的文件夹中创建的。 要查看格式副本，请打开宣传品并选择 **[!UICONTROL 节目]** 从GlobalNav列表中。
...
1. 在 [!DNL Experience Manager] 界面，选择 [!UICONTROL 资产] 在导航页面上。
...
1. 从 [!UICONTROL 模板合并] 页面，选择 **[!UICONTROL 合并]** ![添加资产](assets/do-not-localize/assets_add_icon.png).
...
1. 选择 **[!UICONTROL 下一个]** 工具栏中。
1. 在 **[!UICONTROL 预览和重新排序]** 屏幕，根据需要重新排列模板并预览所选要合并的模板。 在工具栏中，选择 **[!UICONTROL 下一个]**.
...
1. 选择 **[!UICONTROL 保存]**，然后选择以关闭对话框 **[!UICONTROL 确定]**. 多页宣传资料是在您开始使用的文件夹中创建的。
