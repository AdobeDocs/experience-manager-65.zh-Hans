...
>[!NOTE]
>
>如果您是Experience Manager Sites和/或Experience Manager E-commerce客户，请跳过此步骤。 您无需手动标识热点或图像映射变量；您可以将与电子商务的集成用于产品集成。 查看有关[设置电子商务](/help/commerce/cif-classic/administering/generic.md)的信息。 此外，您还可以使用交互式组件并将其添加到网页。
>
