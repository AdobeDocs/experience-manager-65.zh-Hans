...
>[!NOTE]
>
>* 智能内容服务不再可供新用户使用 [!DNL Experience Manager Assets] 内部部署客户。 已启用此功能的现有内部部署客户可以继续使用智能内容服务。
>* 智能内容服务可用于现有 [!DNL Experience Manager Assets] 已启用此功能的Managed Services客户。
>* 新建 [!DNL Experience Manager Assets] Managed Services客户可以按照本文中所述的说明设置智能内容服务。
...
1. 选择&#x200B;**[!UICONTROL 上传您的公共密钥]**。提供从 [!DNL Experience Manager] 下载的证书文件。此时将显示“[!UICONTROL 公共密钥上传成功]”消息。单击&#x200B;**[!UICONTROL 下一步]**。
   ...
   [!UICONTROL 创建新的服务帐户(JWT)凭据] 此页显示服务帐户的公钥。
...
您可以使智能内容服务定期针对文件夹中的资源和关联标记进行培训。 打开 [!UICONTROL 属性] 页面，选择 **[!UICONTROL 启用智能标记]** 在 **[!UICONTROL 详细信息]** 选项卡，并保存更改。

![enable_smart_tags](assets/enable_smart_tags.png)

为文件夹选择此选项后， [!DNL Experience Manager] 自动运行培训工作流，对文件夹资产及其标记上的智能内容服务进行培训。 默认情况下，培训工作流每周于星期六凌晨12:30运行。
...
1. 在 **[!UICONTROL 运行工作流]** 对话框，浏览到有效负荷文件夹，其中包含用于培训服务的已标记资产。
...
* 增强型智能标记基于图像及其标记的学习模型。 这些模型在识别标记方面并不总是完美的。 当前版本的智能内容服务具有以下限制：
   ...
   * 在以下区域设置中支持标记 [!DNL Experience Manager] 中支持。
