...
借助Adobe Experience Manager (AEM)，您可以使用AEM GraphQL API有选择地访问您的内容片段，以仅返回所需的内容。 这意味着您可以实施结构化内容的 Headless 传递以便在您的应用程序中使用。
...
* 访问GraphiQL（如有必要）
  * [AEM GraphiQL界面](/help/sites-developing/headless/graphql-api/graphql-api-content-fragments.md#graphiql-interface)
