...
在开始掌握内容片段之前，您可以快速大致了解如何使用....但任何内容都不能真正取代登录和尝试使用系统的体验。
...
* **关联的内容**
  ...
  对于相当多的版本，内容片段已在 AEM 中提供。 最初，在创作页面时，这些量度可用于“传统”....，并且仍用于此上下文。 这可能涉及关联资产（例如图像），虽然这些资产未嵌入片段中，但在创作页面时，作者需要能够使用这些资产。
