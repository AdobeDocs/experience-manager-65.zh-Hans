...
在AEM Headless翻译历程的上一个文档中， [配置翻译规则](translation-rules.md) 您已了解如何使用AEM翻译规则来标识翻译内容。 您现在应：
...
1. 导航到&#x200B;**导航** > **项目**。
1. 单击 **创建** > **文件夹** 以便为您的项目创建文件夹。
   * 虽然这是一项可选操作，但有助于组织您的翻译工作。
1. 在 **创建文件夹** 窗口，添加 **标题** ，然后单击 **创建**.

   ![创建项目文件夹](assets/create-project-folder.png)

1. 单击文件夹以打开该文件夹。
1. 在新项目文件夹中，单击 **创建** > **项目**.
1. 项目基于模板。单击 **翻译项目** 模板以选择它，然后单击 **下一个**.
...
1. 在 **高级** 选项卡，使用 **目标语言** 下拉列表以选择应将内容翻译成的语言。 单击&#x200B;**创建**。
...
1. 单击其中一个页面底部的省略号按钮 **翻译作业** 卡片。
1. 您将看到该作业不含任何内容。单击 **添加** 按钮，然后 **资产/页面** 从下拉菜单中查找。
...
>[!TIP]
>
>路径浏览器是一个功能强大的工具，可让您搜索、过滤和导航您的内容。单击 **仅限内容/过滤器** 按钮来切换侧面板并显示高级过滤器，例如 **修改日期** 或 **翻译状态**.
>
...
[如前所述，](#using-translation-project) 机器翻译的内容流回AEM，状态为 **已批准** 因为假定使用的是机器翻译，所以不需要人工干预。 但仍可审查已翻译的内容。
...
如果您通过以下方式导航到此文件夹 **导航** > **资产** > **文件**，您将看到翻译的内容。
