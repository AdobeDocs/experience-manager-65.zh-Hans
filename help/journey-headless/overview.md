...
如果您不熟悉AEM和/或Headless，AEM Headless历程是您开始通过叙述方式了解理论和技术的绝佳地方，从而以Headless方式解决各种业务问题。
...
| [Headless 翻译历程](/help/journey-headless/translation/overview.md) | 了解Headless技术，为什么在您的项目中使用它们，以及如何在AEM中创建和更新翻译项目。 | 翻译专家 |
