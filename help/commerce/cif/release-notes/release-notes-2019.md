...
* 所有便于作者使用的CIF核心组件均已得到增强，可支持[AEM的样式系统](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/siteandpage/style-system.html)。 为产品列表组件提供了示例样式。
