...
| CIF 核心组件 | 1.6.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF Venia参考站点 | 2020.12.01 | [发行说明](https://github.com/adobe/aem-cif-guides-venia/releases) |
...
| CIF 核心组件 | 1.5.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF Venia参考站点 | 2020.10.27 | [发行说明](https://github.com/adobe/aem-cif-guides-venia/releases) |

### 新增功能 {#what-is-new-october}

* 添加了新类别轮盘组件，以允许商业用户将此组件拖放到AEM内容页面上，以使用商业数据扩充内容页面。

* CIF核心组件已扩展，可通过发送商业数据来水合Adobe客户端数据层。 Adobe Client Data Layer是一种标准化方法，用于收集数据并将数据传递到Digital Analytics和报表服务器。 有关更多详细信息，请参阅[Adobe客户端数据层](https://github.com/adobe/adobe-client-data-layer/wiki)。
...
| CIF 核心组件 | 1.4.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF Venia参考站点 | 2020.10.2 | [发行说明](https://github.com/adobe/aem-cif-guides-venia/releases) |
...
| CIF 核心组件 | 1.3.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF Venia参考站点 | 2020.9.2 | [发行说明](https://github.com/adobe/aem-cif-guides-venia/releases) |

### 新增功能 {#what-is-new-august}

* 添加了痕迹导航组件以支持内容和商务页面。

* 在页面属性上添加了Commerce选项卡，以公开用于登陆页面和体验片段的CIF属性。
...
| CIF 核心组件 | 1.2.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF Venia参考站点 | 2020.8.14 | [发行说明](https://github.com/adobe/aem-cif-guides-venia/releases) |

### 新增功能 {#what-is-new-july}

* CIF Venia引用站点是从CIF原型存储库中提取的，现在是一个独立的GitHub存储库。

* CIF原型已与AEM项目原型合并。 对于新项目，请使用[AEM项目原型](https://github.com/adobe/aem-project-archetype)作为起点。
...
| CIF 核心组件 | 1.1.1 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
...
| CIF 核心组件 | 1.0.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF原型 | 0.11.0 | [发行说明](https://github.com/adobe/aem-cif-project-archetype/releases) |
...
| CIF 核心组件 | 0.10.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
| CIF原型 | 0.10.0 | [发行说明](https://github.com/adobe/aem-cif-project-archetype/releases) |

### 新增功能 {#what-is-new-april}

* 统一并简化了CIF连接器的配置设置。 有关更多详细信息，请查看[快速入门](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/home.html?lang=zh-Hans)或[新的AEM CIF项目设置](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/home.html?lang=zh-Hans)
...
| CIF 核心组件 | 0.9.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
...
| CIF 核心组件 | 0.8.0 | [发行说明](https://github.com/adobe/aem-core-cif-components/releases) |
