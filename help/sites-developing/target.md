...
例如，如果要使用[Marketing CloudID服务](https://experienceleague.adobe.com/docs/id-service/using/home.html)，则需要下载mbox.js，使其包含基于租户的`imsOrgID`变量的正确值。 要与Marketing CloudID服务集成，需要此变量。 有关信息，请参阅[Adobe Analytics作为Adobe Target的报表Source](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/a4t.html)和[在实施之前](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/before-implement.html)。
