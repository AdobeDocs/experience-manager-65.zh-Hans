...
此外，**Granite工作流外部进程作业队列**&#x200B;有单独的配置。 用于启动外部二进制文件的工作流进程，如&#x200B;**InDesign Server**&#x200B;或&#x200B;**Magick**。
...
默认情况下，**每周维护时段**&#x200B;具有&#x200B;**工作流清除**&#x200B;任务，但需要先配置该任务才能运行。 要配置工作流清除，必须在Web控制台中添加新的&#x200B;**Adobe Granite工作流清除配置**。
...
* 旧版工作流设计（设计时和运行时）保存在以下路径下：
  ...
  >[!NOTE]
  >
  >如果这些设计是使用&#x200B;*AEM UI*&#x200B;编辑的，则详细信息将会复制到新位置。
...
* 旧版工作流启动器位于以下路径下：
  ...
  >[!NOTE]
  >
  >如果这些定义使用&#x200B;*AEM UI*&#x200B;编辑，则详细信息将复制到新位置。
