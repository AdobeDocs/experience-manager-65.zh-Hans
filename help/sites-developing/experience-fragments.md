...
可以在AEM[&#128279;](/help/sites-administering/experience-fragments-target.md#Prerequisites)的创作实例上启用此功能。 它需要有效的Adobe Target配置以及Link Externalizer配置。
...
1. AEM修改HTML中存在的任何内部链接，使其指向已发布的资源。
