...
为了营造一个开放和友好的环境，文档团队作为贡献者和维护者，承诺确保每个人在参与项目和社区时都能获得无骚扰的体验。无论年龄、体型、残障、种族、性别认同和表达、经验水平、国籍、个人外貌、肤色、宗教信仰或性取向如何，均应受到尊重与包容。
...
当个人代表项目或其社区时，本行为准则同时适用于项目空间和公共空间。代表项目或社区的示例包括：使用官方项目电子邮件地址、通过官方社交媒体帐号发帖，或作为指定代表参加线上或线下活动。项目的呈现方式可由项目维护者进一步定义和解释。

## 强制执行

如果要举报辱骂、骚扰或其他不可接受的行为事件，请通过 Grp-opensourceoffice@adobe.com 联系项目团队。所有投诉都会经过审查和调查，并会根据具体情况做出必要且适当的回应。项目团队有义务为事件举报者保密。具体执行策略的更多细节可能会单独发布。
